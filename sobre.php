...
<head>
  ...
  <title> Reabilita Alagoas - Sobre o Projeto </title>
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
            ...
            <ul>
              ...
              <li><i class="ri-check-double-line"></i> Informações de documentos para os serviços de reabilitação</li>
              <li><i class="ri-check-double-line"></i> Gratuidade no uso do site</li>
            </ul>
          </div>
        </div>
