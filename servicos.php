...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><span>⚕️Reabilita</span> Alagoas</a></h1>
  ...
  <section id="contact" class="contact">
      <div class="container">
            ...
            <form action="#" method="post" role="form" class="php-email-form">
              <div class="row">
                ...
                <div class="col-md-4 form-group mt-3 mt-md-0">
                  <input type="number" class="form-control" name="idade" id="idade" placeholder="Idade" required>
                </div>
              </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cidade" placeholder="Digite a cidade" required readonly>
        </div>

        <!-- Campo Endereço - Estado -->
        <div class="form-group">
            <label for="estado">Estado</label>
            <input type="text" class="form-control" id="estado" placeholder="Digite o estado" required readonly>
        </div>

            
              <div class="form-group col-md-6"><select class="form-control" id="deficiencia" required>
